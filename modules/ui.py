                    ...
                    if category == "prompt":
                        ...
                        with FormRow():
                            with gr.Column(elem_id="txt2img_column_size", scale=4):
                                width = gr.Slider(minimum=64, maximum=4096, step=64, label="Width", value=1024, elem_id="txt2img_width")
                                height = gr.Slider(minimum=64, maximum=4096, step=64, label="Height", value=1024, elem_id="txt2img_height")
                            ...
                            with gr.Column(elem_id="img2img_column_size", scale=4):
                                ...
                                with gr.Tabs(elem_id="img2img_tabs_resize"):
                                    with gr.Tab(label="Resize to", id="to", elem_id="img2img_tab_resize_to") as tab_scale_to:
                                        with FormRow():
                                            with gr.Column(elem_id="img2img_column_size", scale=4):
                                                width = gr.Slider(minimum=64, maximum=4096, step=64, label="Width", value=1024, elem_id="img2img_width")
                                                height = gr.Slider(minimum=64, maximum=4096, step=64, label="Height", value=1024, elem_id="img2img_height")
